...
Как подключить **любое** Node/Nitro-приложение к общей станции телеметрии — авто-спаны
(http/pg/ioredis) за 3 шага. Ручные спаны (по своим операциям) — опционально, см. ниже.

> **Источник истины — корневой `otel.instrument.mjs` в репо приложения импорта прайсов.** Этот
