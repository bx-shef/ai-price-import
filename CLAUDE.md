...
- **Веб-аналитики на сайте НЕТ** (решение владельца 2026-08-04, #297): счётчик собирает IP и cookie
  ...
  появляется раньше самого счётчика). Подключение возможно, но **только после** новой редакции
  Политики сайта: обратный порядок = месяц обработки вопреки опубликованному документу.
