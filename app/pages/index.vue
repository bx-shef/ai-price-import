          ...
          <div class="mx-auto grid max-w-[1080px] gap-5 md:grid-cols-2">
            ...
            >
              ...
              <p class="text-base leading-relaxed text-white/90 sm:text-lg">
                ...
                сделку/счёт с товарами 1-в-1. Сверять нечего.
              </p>
            </div>
          </div>
        </section>
        ...
        >
          ...
          <div class="mx-auto max-w-[1080px] rounded-3xl border border-cyan-400/20 bg-gradient-to-b from-cyan-500/[0.07] to-white/[0.02] py-6 shadow-[0_0_80px_rgba(34,211,238,0.06)] sm:p-10">
            ...
            <p class="mx-auto mb-8 max-w-2xl px-4 text-center text-sm text-white/60 sm:px-0">
              Прикрепите PDF, скан, Excel, Word или CSV — покажем, что распознаём: контрагента,
        ...
        >
          ...
          <div class="mx-auto max-w-[900px] rounded-3xl border border-white/10 bg-gradient-to-br from-cyan-500/[0.10] to-indigo-500/[0.06] py-8 sm:p-12">
            ...
            <p class="mb-6 px-8 text-lg text-white/70 sm:px-0">
              Свои поля, свои сущности, свой источник документов — расскажите, что нужно, и мы
              предложим решение. Ответим в течение рабочего дня.
            </p>
            ...
            <div class="mx-8 mb-8 rounded-2xl border border-cyan-400/20 bg-cyan-400/[0.06] p-5 sm:mx-0">
              ...
              <!-- #96: оговорка про внешний разбор — на ЛЕНДИНГЕ, а не только в портальном виджете.
                   Лендинг читают до установки, то есть до любого разговора с нами, и «свой сервер»
                   без неё читается как «данные не покидают контур». -->
              <!-- Размер и яркость — как у основного абзаца: это утверждение существует ровно
                   затем, чтобы человек НЕ ушёл с ложным выводом, и «мелкий шрифт под договором»
                   для него — неверный приём. Отличается началом («Важно:»), а не бледностью. -->
              <p class="mt-3 text-sm leading-relaxed text-white/70">
                {{ LANDING_SOURCES.note }}
              </p>
            </div>
            <BriefForm />
          </div>
