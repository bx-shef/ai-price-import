...
<template>
  <div class="mx-auto w-full max-w-2xl p-4 sm:p-6">
    ...
    <div class="mt-4 flex flex-wrap gap-2">
      ...
      />
      <!-- ⚠ Второй путь закрытия ТОЙ ЖЕ страницы. В SDK оба шлют одну команду и отличаются лишь
           флагом, то есть разницы быть не должно — но «не должно» это вывод из чтения исходника, а
           не наблюдение. Стенд затем и нужен, чтобы такие выводы проверять. -->
      <B24Button
