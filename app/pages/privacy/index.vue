...
// ⚠ Заголовок — тот же, что в реестре архива (`app/config/legalArchive.ts`): один документ не может
// называться по-разному в зависимости от того, с какого адреса на него смотрят.
