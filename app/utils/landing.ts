...
export const LANDING_WHY_SUBTITLE = 'Бесплатное приложение закрывает импорт. Настройку под ваши процессы берём на себя; работу в вашем контуре готовы обсудить отдельно.'
