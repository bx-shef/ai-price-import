...
export const LANDING_HERO_NOTE = 'Приложение ставится из Маркета Битрикс24 и закрывает импорт. Настройку под ваш процесс берём на себя.'
...
export const LANDING_MARKET_PROMO = {
  ...
  text: 'Приложение есть в Маркете Bitrix24. Установите за минуту и загружайте документы прямо в портале — условия подписки указаны в карточке Маркета.',
