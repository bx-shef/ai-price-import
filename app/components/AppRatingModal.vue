  ...
  >
    <template #body>
      <div class="flex flex-col items-center gap-4 text-center">
        <!-- ⚠ Подсказки-записи здесь СЕЙЧАС нет намеренно (#380). Она была, но снята с показа: на
             ролике карточка ЧУЖОГО приложения — чужие логотип и название. Человек, которого просят
             оценить «AI-импорт прайсов», видел в инструкции посторонний продукт, а это хуже, чем
             отсутствие подсказки. Решение владельца — не удалять затею, а переснять; запись делает
             человек на живом портале, синтетическая анимация «похожая на скриншот» была бы
             подделкой. До новой записи модалка обходится текстом: кнопка «Оценить» и так открывает
             нужную страницу Маркета одним кликом, объяснять там нечего. -->
