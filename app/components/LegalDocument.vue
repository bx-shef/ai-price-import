...
<template>
  ...
  >
    ...
    <!-- Источник — наш собственный файл в репозитории, и рендер экранирует ВСЁ до разбора
         ...
         Это ПЕРВОЕ из ДВУХ мест в проекте с v-html; второе — текст объявления издателя
         (`AnnouncementDialog.vue`, #473 п.6), и оно намеренно того же вида: тот же рендер, та же
         причина. ⚠ Строка до 12.08.2026 утверждала «единственное место» и пережила появление
         второго: следующий, ищущий все v-html, прочитал бы у первого же вхождения «единственное»
         и не стал бы искать дальше. Третьего места быть не должно. -->
