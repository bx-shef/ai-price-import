      ...
      <div class="flex items-start gap-3">
        ...
        <div class="min-w-0">
          ...
          <p class="mt-1 text-sm opacity-90 sm:text-base">
            Настроить импорт под ваши документы и забирать прайсы самим — из почты, Telegram, по FTP
            или из другого источника — можно и на вашем сервере, без общей очереди. Условия и сроки
