...
import { SHELL_VARS } from '~/config/landingShell'
...
.cookie-btn-primary { background: var(--legal-link); color: #05010f; border: 1px solid transparent; }
