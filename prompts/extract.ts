...
3. НДС единый по всему документу: определи, включён ли НДС в цены (priceIncludesVat) — одно значение на весь
   документ. Ставку каждой позиции (vatRate, число процентов, напр. 0/10/20) бери как напечатано у строки.
