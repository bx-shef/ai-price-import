...
- **Блок «Индивидуальная доработка под ваш процесс»** — платная фича поверх стандартного приложения
  ...
  **по артикулу**, **загрузку вне портала** (standalone/по почте/из папки) и другие правила под ваш
  учёт». Сюда уходят убранные из стандарта фичи — подбор договора (Q8) и standalone-загрузка
  (стандартное приложение работает **только внутри портала Б24**) — как продающее предложение,
  а не ядро продукта.
