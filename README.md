...
>
> ⚠️ **Идёт редизайн.** Этот README описывает **старую** реализацию (код перенесён в
> [`legacy/`](legacy/)). Актуальные архитектура, процесс, стек и решения нового проекта —
> в [`docs/redesign/`](docs/redesign/README.md); краткая памятка — [`CLAUDE.md`](CLAUDE.md).
> Новый проект: облачное приложение Маркета Bitrix24, интеграция только через MCP + стандартный REST.
...
**Обновить upstream MCP:** каноническая процедура — в [`mcp/VENDOR.md`](legacy/mcp/VENDOR.md)
...
- [mcp/docs/RUNBOOK.md](legacy/mcp/docs/RUNBOOK.md) — on-call MCP: алерт→действие, откат, разбор по логам
...
- [prompts/main.md](legacy/prompts/main.md) — системный промпт агента
