...
-- ⚠ portal_consent УДАЛЕНА (#438, решение владельца 2026-08-05). Экран согласия внутри портала
-- снят: принятие условий собирает Маркет ДО установки, п. 2.7 Лицензионного соглашения считает его заключённым
-- с момента установки, а п. 4.3.2 («Загружая Документ») даёт подтверждение прав на каждый документ. Своя запись ничего не доказывала сверх той, что
-- видна издателю в личном кабинете Маркета, зато требовала обращения к базе на каждый документ.
-- ⚠ DROP, а не «оставить на всякий случай»: клиентов ещё не запускали, мигрировать нечего, а
