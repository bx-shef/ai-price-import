...
-- снят: принятие условий собирает Маркет ДО установки, а п. 4.3.2 Лицензионного соглашения
-- привязывает подтверждение к действию загрузки. Своя запись ничего не доказывала сверх той, что
