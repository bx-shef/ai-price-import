...
//
// Where this sits relative to the other two observability paths, so the three do not grow into
...
//
// NB this is the opposite of the decision for failed documents (#289), and deliberately so. There,
// every failure is a DIFFERENT document a person is waiting for, and the repetition is the signal.
// Here every tick is the SAME breakage, and the repetition is noise.
 ...
 *
 * Three things this has to get right, each of which was wrong in an earlier draft:
 *
