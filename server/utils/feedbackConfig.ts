// Feedback channel config (#122/#182): enabled ONLY when a token AND a valid receiving repo are set.
// Fail-closed on purpose — unlike the legacy default (which pointed at the PUBLIC code repo), we do
// NOT default the repo: an unconfigured channel stays OFF rather than risk writing client context
// (employee comments) into a public repo. The owner points GITHUB_FEEDBACK_REPO at a PRIVATE repo.
